                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
                    <div className="space-y-4">
                        ...
                        <p className="text-slate-400 font-medium max-w-lg">
                            Bạn đã duy trì chuỗi học tập được {stats.streak_days} ngày liên tiếp. Hãy hoàn thành thêm bài học để nhận huy hiệu nhé!
                        </p>
                    </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                ...
                <div className="bg-white rounded-[1.5rem] p-6 shadow-sm border border-slate-100 flex items-center gap-5 slide-up">
                    ...
                    <div>
                        ...
                        <h3 className="text-2xl font-bold text-slate-800">{stats.streak_days} Ngày</h3>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-[1.5rem] p-6 shadow-sm border border-slate-100 flex items-center gap-5 slide-up" style={{ animationDelay: '0.1s' }}>
                    ...
                    <div>
                        ...
                        <h3 className="text-2xl font-bold text-slate-800">{stats.study_hours} Giờ</h3>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-[1.5rem] p-6 shadow-sm border border-slate-100 flex items-center gap-5 slide-up" style={{ animationDelay: '0.2s' }}>
                    ...
                    <div>
                        <p className="text-sm font-semibold text-slate-500 mb-1">Trạm học hoàn thành</p>
                        <h3 className="text-2xl font-bold text-slate-800">{stats.completed_nodes} Bài</h3>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-[1.5rem] p-6 shadow-sm border border-slate-100 flex items-center gap-5 slide-up" style={{ animationDelay: '0.3s' }}>
                    ...
                    <div>
                        ...
                        <h3 className="text-2xl font-bold text-slate-800">{stats.avg_score} Đ</h3>
                    </div>
                </div>
