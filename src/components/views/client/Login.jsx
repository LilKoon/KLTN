                    ...
                    <div className="w-full max-w-[500px] relative">
                        ...
                        <div className="bg-white rounded-[2rem] shadow-2xl border border-white/60 overflow-hidden relative w-full z-10 transition-all duration-300"
                            ...
                            <div id="loginForm"
                                ...
                                <form id="login" onSubmit={(e) => { e.preventDefault(); login('client'); }} className="space-y-4">
                                    {/* Email Field */}
                                    <div>
                                    ...
                                    <button type="submit"
                                        className="w-full bg-teal-600 hover:bg-teal-700 text-white font-semibold py-3.5 px-4 rounded-2xl shadow-lg shadow-teal-600/30 hover:shadow-teal-700/40 transition-all focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 mt-2">
                                        Đăng nhập
                                    </button>
                                </form>
                            ...
                            <div id="registerForm"
                                ...
                                <form id="register" onSubmit={(e) => { e.preventDefault(); login('client'); }} className="space-y-4">
                                    ...
                                    <button type="submit"
                                        className="w-full bg-teal-600 hover:bg-teal-700 text-white font-semibold py-3.5 px-4 rounded-xl shadow-lg shadow-teal-600/30 hover:shadow-teal-700/40 transition-all focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 mt-4">
                                        Hoàn tất Đăng ký
                                    </button>
